...
public class ButtonRender extends ComponentRenderer<Button> {
    ...
    @Override
    public void render(IVertexBuilder builder, Button instance, MatrixStack transform) {
        RenderHelper helper = new RenderHelper(builder);
        ...
        helper.renderColoredBox(transform, BOX_MIN, BOX_MAX, colors);
    }
}
