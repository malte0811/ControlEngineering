...
public class Trace {
    ...
    public void addSample(List<ModuleInScope> modules, BusState input) {
        this.samples.add(getOwner(modules).module().getDivRelativeSample(traceId.traceIdWithinModule(), input));
    }
