...
public class ClientConstantSymbol extends ClientSymbol<Integer, ConstantSymbol> {
    ...
    @Override
    public void renderCustom(GuiGraphics graphics, int x, int y, @Nullable Integer state, int alpha) {
        ...
        TextUtil.renderBoxWithText(graphics, colorWithAlpha, text, 5, x, y, BOX_SIZE, BOX_SIZE);
    }
