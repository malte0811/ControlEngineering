...
public class AssociativeFunctionCell extends StatelessCell {
    ...
    public AssociativeFunctionCell(int numInputs, IBooleanFunction func, boolean baseState) {
        this(numInputs, (a, b) -> func.apply(bool(a), bool(b)) ? 1 : 0, baseState ? 1 : 0);
    }

    public AssociativeFunctionCell(int numInputs, DoubleBiFunction func, double baseState) {
        super(
