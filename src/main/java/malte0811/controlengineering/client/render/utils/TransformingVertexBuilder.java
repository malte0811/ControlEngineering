...
//TODO copied from IE
public class TransformingVertexBuilder extends VertexConsumerWrapper {
    ...
    public VertexConsumer addVertex(Vec3 position) {
        return addVertex((float) position.x, (float) position.y, (float) position.z);
    }

    @Nonnull
    @Override
    public VertexConsumer setNormal(float x, float y, float z) {
        return setNormal(new Vector3f(x, y, z));
    }

    @Nonnull
    public VertexConsumer setNormal(Vector3f normal) {
