...
public class Matrix4 {
    ...
    private void setFacingMat(Direction facing, double factor) {
        setIdentity();
        translate(.5, .5, .5);
        rotateFacing(facing, factor);
        translate(-.5, -.5, -.5);
    }

    public void rotateFacing(Direction facing, double factor) {
        switch (facing) {
            case UP:
    ...
    public String toString() {
        ...
        return "[" + new BigDecimal(m00, cont) + "," + new BigDecimal(m01, cont) + "," + new BigDecimal(
                m02,
                cont
        ) + "," + new BigDecimal(m03, cont) + "]\n" +
                "[" + new BigDecimal(m10, cont) + "," + new BigDecimal(m11, cont) + "," + new BigDecimal(
                m12,
                cont
        ) + "," + new BigDecimal(m13, cont) + "]\n" +
                "[" + new BigDecimal(m20, cont) + "," + new BigDecimal(m21, cont) + "," + new BigDecimal(
                m22,
                cont
        ) + "," + new BigDecimal(m23, cont) + "]\n" +
                "[" + new BigDecimal(m30, cont) + "," + new BigDecimal(m31, cont) + "," + new BigDecimal(
                m32,
                cont
    ...
    public ClipContext transformRay(Vec3 start, Vec3 end) {
